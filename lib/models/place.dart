...
class PlaceLocation {
  ...
  final String? address;    // Endereço opcional formatado como texto. O '?' indica que pode ser nulo.
...
class Place {
  ...
  final PlaceLocation location; // Objeto do tipo PlaceLocation, contendo os dados de localização.
  final File image;             // Arquivo da imagem associada ao lugar, salvo no dispositivo.
